...
- `skills-dirs` defaults to `[~/.agents/skills]`, or `[~/.agents/skills, <mods executable directory>/skills]` in portable mode.
...
- Default effective dirs are `[~/.agents/skills]`, or `[~/.agents/skills, <mods executable directory>/skills]` in portable mode.
