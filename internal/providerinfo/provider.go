...
var descriptors = map[string]Descriptor{
	...
	"opencode-go": {
		Protocol:       "openai",
		Profile:        "openai",
		Description:    "OpenCode Go (OpenAI-compatible models)",
	...
	"opencode-go-anthropic": {
		Protocol:       "anthropic",
		Profile:        "anthropic",
		Description:    "OpenCode Go (Anthropic models: MiniMax, Qwen)",
		DefaultBaseURL: "https://opencode.ai/zen/go/v1/messages",
		APIKeyEnv:      "OPENCODE_GO_API_KEY",
		APIKeyURL:      "https://opencode.ai/auth",
	},
