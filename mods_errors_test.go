...
func TestHandleAPIError(t *testing.T) {
	...
	t.Run("404 without fallback returns error", func(t *testing.T) {
		...
		require.True(t, ok)
		require.Contains(t, merr.reason, "Missing model")
	})
	...
	t.Run("400 context_length_exceeded no_limit returns error", func(t *testing.T) {
		...
		merr, ok := msg.(modsError)
		require.True(t, ok)
		require.Contains(t, merr.reason, "Maximum prompt size exceeded")
	})
	...
	t.Run("400 other returns error", func(t *testing.T) {
		...
		merr, ok := msg.(modsError)
		require.True(t, ok)
		require.Contains(t, merr.reason, "API request error")
	})
	...
	t.Run("401 returns error", func(t *testing.T) {
		...
		merr, ok := msg.(modsError)
		require.True(t, ok)
		require.Contains(t, merr.reason, "Invalid")
	})
	...
	t.Run("413 returns error", func(t *testing.T) {
		...
		merr, ok := msg.(modsError)
		require.True(t, ok)
		require.Contains(t, merr.reason, "Request too large")
	})
	...
	t.Run("500 non-openai returns error", func(t *testing.T) {
		...
		merr, ok := msg.(modsError)
		require.True(t, ok)
		require.Contains(t, merr.reason, "Error loading model")
	})
...
func TestHandleRequestError(t *testing.T) {
	...
	t.Run("non-openai error returns generic message", func(t *testing.T) {
		...
		merr, ok := msg.(modsError)
		require.True(t, ok)
		require.Contains(t, merr.reason, "API request")
	})
}
