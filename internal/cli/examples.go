...
var examples = map[string]string{
	...
	"Save a session":                   `mods --title project-summary "Summarize this repository"`,
	"Continue a session":               `mods --continue project-summary "Turn that summary into release notes"`,
